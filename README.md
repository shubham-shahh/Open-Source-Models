...
* Add the source links(blogs, github repo) to the model and all the supporting files in the respective category along with information such as, number of classes, name of classes, number of images used for training and if possible also include a performance metric.
